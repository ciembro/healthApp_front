...
import com.ciembro.healthappfront.extrasuper.service.WeatherApiService;
...
public class RegisterForm extends VerticalLayout {
    ...
    public RegisterForm(){
        ...
        binder.forField(email).bind(UserToRegisterDto::getLocation, UserToRegisterDto::setLocation);
